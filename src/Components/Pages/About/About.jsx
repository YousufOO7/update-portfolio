            ...
            <div className="hero md:px-20 pt-10">
                <div className="hero-content flex-col lg:flex-row w-full">
                    <div className="lg:w-1/2 mr-5">
                        <img src="/image.png" alt="" className="w-[40vw] lg:w-[25vw] h-[30vw] rounded-md" />
                    </div>
                    {/* text */}
                    <div className="lg:w-1/2">
                       <h1 className="text-5xl font-bold">About Me!</h1>
                        ...
                        <p className="py-6">
                            ...
                            After completing my HSC, I began exploring platforms and institutions to learn coding and technology. In June 2023, I joined Programming Hero to pursue my dream of becoming a developer. Balancing my studies with the demands of this rigorous course wasn’t easy, but with determination and the grace of Almighty Allah, I successfully completed all 11 assignments on time. This month, January 2025, marks the completion of my course, and I am proud to call myself a front-end developer.
